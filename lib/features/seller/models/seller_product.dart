...
class SellerProduct {
  ...
  final List<AppMedia> images;

  String get priceLabel =>
      '\$${price.toStringAsFixed(price.truncateToDouble() == price ? 0 : 2)}';

  AppMedia? get coverImage => images.isEmpty ? null : images.first;

  factory SellerProduct.fromJson(Map<String, dynamic> json) {
    final attributes = json['attributes'] as Map<String, dynamic>? ?? <String, dynamic>{};
    ...
    return SellerProduct(
      ...
      images: AppMedia.listFrom(source['images']),
    );
  }
